...
?>
        <footer>
            ...
            <div class="container">
                ...
                <!-- Section des réseaux sociaux (à droite) -->
        ...
        <script src="js/script_newsletter.js"></script>
<?php
        $output = ob_get_clean(); // Récupère le contenu du tampon et termine la mise en tampon
        return $output;
    }
}
?>
